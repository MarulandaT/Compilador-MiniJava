...
def p_CLASS_DECL_LIST(p):
  ...
  evaluar(p, "LISTA DECLARACION DE CLASES")
...
def p_CLASS_DECL(p):
  ...
  evaluar(p, "DECLARACION DE CLASES")
...
def p_FIELD_OR_METHOD_DECL_LIST(p):
  ...
  evaluar(p, "LISTA DECLARACION DE CAMPOS Y/O METODOS")
                    
def p_FIELD_DECL(p):
  '''FIELD_DECL : TYPE ID FINALIZADOR
                | TYPE ID LIST_AUX_IDS ';' '''
  evaluar(p, "DECLARACION DE CAMPO")
  
def p_LIST_AUX_IDS(p):
  '''LIST_AUX_IDS : COMA ID 
                  | COMA ID LIST_AUX_IDS'''
  evaluar(p, "LISTA AUXILIAR DE IDS")
...
def p_METHOD_DECL(p):
  ...
  evaluar(p, "DECLARACION DE METODO")
...
def p_VAR_DECL_STATEMENTS_LIST(p):
  ...
  evaluar(p, "LISTA DE VAR_DECL Y ENUNCIADOS") 
...
def p_VAR_DECL(p):
  ...
  evaluar(p, "DECLARACION DE VARIABLE")
...
def p_LIST_IDS_EXPRESSIONS(p):
  ...
  evaluar(p, "LISTA DE IDS Y EXPRESIONES")
